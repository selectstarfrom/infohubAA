...
public class MimeMapper implements EmbeddedServletContainerCustomizer {
	...
	public void customize(ConfigurableEmbeddedServletContainer container) {
		...
		container.addErrorPages(new ErrorPage(HttpStatus.NOT_FOUND, "/views/404.xhtml"));
		container.addErrorPages(new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR, "/views/error.xhtml"));
	}
}